   ...
   <>
    ...
    <S.AboutMeWrap>
        <div className="about-content">
            ...
            <li>
                Currently residing on the east side of Cincinnati with my fiancée, Allissa, and our dog, Jagg.
            </li>
            <h1>
                Hobbies
            </h1>
            ...
            <li>
                When I have time, I also like to game with my friends.
            </li>
